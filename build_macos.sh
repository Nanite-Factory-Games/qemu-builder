...
./configure --target-list=x86_64-softmmu --cc="clang -arch x86_64" --cxx="clang++ -arch x86_64" || cat /Users/runner/work/qemu-builder/qemu-builder/qemu/build/meson-logs/meson-log.txt
